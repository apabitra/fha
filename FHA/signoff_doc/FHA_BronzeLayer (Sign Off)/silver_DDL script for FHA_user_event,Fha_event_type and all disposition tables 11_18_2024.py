...
# MAGIC MANAGED LOCATION 'abfss://silver@adlsdidevcus.dfs.core.windows.net/fha/managed/cba14';				
# MAGIC USE cba14;
# MAGIC
...
# MAGIC ) USING DELTA
# MAGIC location 'abfss://silver@adlsdidevcus.dfs.core.windows.net/fha/external/cba14/SERVICER_ASSET_DISPOSITION_PATH';
# MAGIC
# MAGIC
...
# MAGIC     ) USING DELTA
# MAGIC location 'abfss://silver@adlsdidevcus.dfs.core.windows.net/fha/external/cba14/SERVICER_ASSET_DISPOSITION';
# MAGIC
...
# MAGIC
# MAGIC  ) USING DELTA
# MAGIC location 'abfss://silver@adlsdidevcus.dfs.core.windows.net/fha/external/cba14/SERVICER_ASSET_DISPOSITION_SUMMARY';
...
# MAGIC )USING DELTA
# MAGIC location 'abfss://silver@adlsdidevcus.dfs.core.windows.net/fha/external/cba14/fha_user_event';
...
# MAGIC )USING DELTA
# MAGIC location 'abfss://silver@adlsdidevcus.dfs.core.windows.net/fha/external/cba14/fha_user_event_type';